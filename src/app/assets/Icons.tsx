  ...
  return (
    ...
    >
      <path
        ...
        className={`stroke-neutral-gray-300 ${className}`}
        strokeWidth="2"
        strokeLinecap="round"
...
export const MessagesIconNotification: React.FC<{ hasNotification: boolean; className?: string; }> = ({ hasNotification, className }) => {
  return (
    <div className={`relative ${className}`}>
      <MessagesIcon />
      {hasNotification && (
        <div className="absolute -top-0 -right-0 w-2 h-2 bg-orange-300 rounded-full"></div>
      )}
    </div>
  );
};
...
export function Delete() {
  return (<><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M5.5 0.5H10.5M0.5 3H15.5M13.8333 3L13.2489 11.7661C13.1612 13.0813 13.1174 13.7389 12.8333 14.2375C12.5833 14.6765 12.206 15.0294 11.7514 15.2497C11.235 15.5 10.5759 15.5 9.25779 15.5H6.74221C5.42409 15.5 4.76503 15.5 4.24861 15.2497C3.79396 15.0294 3.41674 14.6765 3.16665 14.2375C2.88259 13.7389 2.83875 13.0813 2.75107 11.7661L2.16667 3M6.33333 6.75V10.9167M9.66667 6.75V10.9167" stroke="#DC4A2D" stroke-linecap="round" stroke-linejoin="round" />
  </svg></>)
}
export function Edit() {
  return (<><svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
    <path d="M12.0001 7.16668L9.33343 4.50001M1.66675 14.8333L3.92299 14.5826C4.19865 14.552 4.33648 14.5367 4.46531 14.495C4.57961 14.458 4.68838 14.4057 4.78867 14.3396C4.90172 14.265 4.99978 14.167 5.1959 13.9709L14.0001 5.16668C14.7365 4.4303 14.7365 3.23639 14.0001 2.50001C13.2637 1.76363 12.0698 1.76363 11.3334 2.50001L2.52923 11.3042C2.33311 11.5003 2.23505 11.5984 2.16051 11.7114C2.09437 11.8117 2.04209 11.9205 2.00509 12.0348C1.96339 12.1636 1.94807 12.3014 1.91744 12.5771L1.66675 14.8333Z" stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
  </svg></>)
}
...
export function Seperator() {
  return (<><svg width="336" height="1" viewBox="0 0 336 1" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="277" height="1" fill="#E7E7E7" />
  </svg>
  </>)
}
